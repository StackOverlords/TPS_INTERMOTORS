import {
  ...
  interface UseCustomTableOptions<TData> {
      ...
      persistColumnSizing?: boolean; // Persistir el tamaño de las columnas
  ...
  export function useCustomTable<TData>({
      ...
      }, [columnVisibility, columnOrder, pagination.pageSize, columnSizing, persistenceKey, persistColumnVisibility, persistColumnOrder, persistPageSize, persistColumnSizing]);
