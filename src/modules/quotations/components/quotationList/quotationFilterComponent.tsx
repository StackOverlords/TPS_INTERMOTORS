...
const QuotationsFiltersComponent: React.FC<QuotationsFiltersProps> = ({
  ...
  const { isFeatureEnabled } = useViewConfig("quotations-list");
  ...
  const handleFechaInicioChange = (date: Date | undefined) => {
    ...
    if (date) {
      // Solo validar que la fecha inicio no sea posterior a fecha fin
  ...
  const handleFechaFinChange = (date: Date | undefined) => {
    ...
    if (date) {
      // Solo validar que la fecha fin no sea anterior a fecha inicio
  ...
  return (
    <section className="space-y-2">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2">
        {isFeatureEnabled("quotationNumberFilter") && (
          ...
          <div className="space-y-2 w-full">
            ...
            <div className="flex gap-2">
              <PopoverDatePicker
                ...
                hasError={dateError}
                disabled={(date) => {
                  // Solo deshabilitar si es posterior a fecha fin
          ...
          <div className="space-y-2 w-full">
            ...
            <div className="flex gap-2">
              <PopoverDatePicker
                ...
                hasError={dateError}
                disabled={(date) => {
                  // Solo deshabilitar si es anterior a fecha inicio
