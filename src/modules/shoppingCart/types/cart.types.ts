...
export interface CartOperationResult {
  ...
  error?:
    ...
    | "ITEM_NOT_FOUND"
    | "UNKNOWN_ERROR";
  warning?: "NO_STOCK" | "EXCEEDS_STOCK";
  message: string;
  data?: {
...
/**
 * Contexto del modal de conversión
 * Determina si está convirtiendo items existentes o importando desde cotización
 */
export type ConversionModalContext =
  | "conversion" // Convirtiendo items que YA están en el carrito
  | "import"; // Importando items de una cotización (AÚN NO están en carrito)
