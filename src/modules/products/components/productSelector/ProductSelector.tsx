...
/**
 * Selector de productos, AGNÓSTICO AL CONTENEDOR.
 *
 * Recibe su configuración por props y avisa por callbacks; no sabe si vive en
 * una ventana secundaria del SO o en un diálogo. Ver el patrón en
...
export interface ProductSelectorConfig {
   ...
   * único para lo que se usaba dentro del componente.
   */
  instanceId: string;
...
/** Producto elegido junto con la cantidad que pidió el usuario. */
export type ProductWithQuantity = ProductGet & { quantity: number };

export interface ProductSelectorProps {
  config: ProductSelectorConfig;
  /** Selección simple: se elige un producto y se termina. */
  onSelectProduct: (product: ProductGet) => void;
  /** Selección múltiple confirmada. */
...
export const ProductSelector = ({
  ...
  const STORAGE_KEY = config.instanceId + "-product-filters";
