...
const BranchesScreen = () => {
  ...
  const totalRecords = useMemo(
    () => branchesData?.meta?.total || 0,
    [branchesData?.meta?.total]
  );
  const isRefreshing = useMemo(
    () => isRefetchingBranchesData || isFetchingBranchesData,
    [isRefetchingBranchesData, isFetchingBranchesData]
  );
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Gestiona las sucursales de la aplicación
                </p>
              </div>
            </div>
          </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem disabled value="false">
                        Inactivos
                      </SelectItem>
                    </SelectContent>
                  </Select>
