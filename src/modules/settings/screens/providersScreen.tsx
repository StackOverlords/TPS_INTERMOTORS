...
const ProvidersScreen = () => {
  ...
  const totalRecords = useMemo(
    () => providersData?.meta?.total || 0,
    [providersData?.meta?.total]
  );
  const isRefreshing = useMemo(
    () => isRefetchingProvidersData || isFetchingProvidersData,
    [isRefetchingProvidersData, isFetchingProvidersData]
  );
  ...
  // Handlers locales
  const handleLocalProveedorChange = useCallback(
  ...
  const handleLocalNitChange = useCallback(
    (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleLocalCodigoInternoChange = useCallback(
    (e: React.ChangeEvent<HTMLInputElement>) => {
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Gestiona los proveedores de la aplicación
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <ProtectedAction
                    ...
                    fallback={
                      ...
                      >
                        ...
                        No tienes permisos para buscar.
                      </Button>
                    }
                  >
