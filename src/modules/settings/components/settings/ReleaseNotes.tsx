...
export default function ReleaseNotes({
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 w-full h-full">
        {/* Columna Izquierda - Contenido/Detalles (2/3) */}
        <div className="lg:col-span-2 flex flex-col h-full overflow-hidden">
          {!showDetails ? (
            // Vista contraída - centrada
              ...
              {!releaseNotes && (
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Usa el botón "Buscar actualizaciones" para verificar si hay
                    nuevas versiones
                  </p>
                </div>
              )}
            ...
            <div className="h-full overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-muted-foreground/20 scrollbar-track-transparent">
              <div className="space-y-3">
                {/* Header - se oculta con el scroll natural */}
                ...
                {/* Botón sticky - se mantiene visible */}
                <div className="sticky top-0 bg-background z-10 pb-2">
                  <Button
                    ...
                    className="px-0 py-1 h-auto"
                  >
                    <ChevronDown className="h-4 w-4 transition-transform duration-300 ease-out rotate-180" />
