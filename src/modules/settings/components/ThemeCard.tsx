...
const renderSystemTheme = () => {
  return (
    <div className="w-full h-full grid grid-cols-2">
      ...
      >
        <div className={cn("p-1 flex gap-1 border-b border-gray-200")}>
        ...
        <div className="grid grid-cols-2 h-full">
          ...
          >
            <div className="flex gap-1 mb-2 items-center">
              <div className={cn("rounded size-3 bg-gray-900")} />
              <div className={cn("h-2 rounded w-2/3 bg-gray-200")} />
            </div>
          ...
          <div className="flex flex-col py-2 pl-2 space-y-1 h-full">
            <div className="flex gap-1 mb-3 items-center justify-between">
              <div className={cn("h-2 bg-gray-200 rounded w-full")} />
            </div>
            <div className={cn("h-1.5 bg-gray-200 rounded w-3/4")} />
            <div className={cn("h-1.5 bg-gray-200 rounded-l w-full")} />
            <div
              className={cn(
      ...
      >
        <div className={cn("p-1 flex border-b border-gray-700")}>
        ...
        <div className="flex flex-col col-span-3 py-2 pr-2 space-y-1 h-full">
          ...
          <div className="h-1.5" />
          <div className={cn("h-1.5 bg-gray-700 rounded-r w-1/4")} />
          <div
            className={cn(
