      ...
      <CardContent className="pt-0">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
          ...
          <div>
            ...
            <p className="text-sm font-medium">{formatDateShort(purchase.fecha)}</p>
          </div>
          ...
          {/* Forma de Compra */}
          <div>
            <Label className="text-xs text-muted-foreground">Forma de Compra</Label>
            <br />
          ...
          <div>
            ...
            <p className="text-sm font-medium">{purchase.proveedor.proveedor}</p>
          </div>
          ...
          {purchase.proveedor.contacto && (
            <div>
              ...
              <p className="text-sm font-medium">{purchase.proveedor.contacto}</p>
            </div>
          )}
