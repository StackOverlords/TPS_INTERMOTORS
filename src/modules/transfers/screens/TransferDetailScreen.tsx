...
import { ArrowLeftRight, Building2, Calendar, CornerUpLeft, Edit, FileText, Loader2, Trash2, User } from "lucide-react";
...
const TransferDetailScreen = () => {
    ...
    const totalTransfer = useMemo(() => {
        ...
        return transferData.detalles.reduce((total, detalle) => {
            const subtotal = Number(detalle.costo_entrada ?? 0) * Number(detalle.cantidad ?? 0);
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <TooltipButton
                                ...
                                tooltip={<p className="flex gap-1">Presiona <Kbd>esc</Kbd> para volver a la lista de transferencias</p>}
                                buttonProps={{
                                    variant: 'default',
                                }}
                            >
                            ...
                            <div>
                                ...
                                {transferData && (
                                    <p className="text-xs text-muted-foreground">
                                        {transferData.cantidad_detalles} {transferData.cantidad_detalles === 1 ? 'producto' : 'productos'}
                                    </p>
                                )}
                            </div>
                        </div >
