...
const AccountsPayableListScreen = () => {
  ...
  const [selectedAccountPayableId, setSelectedAccountPayableId] = useState<
    number | null
  >(null);
  ...
  return (
    <main className="h-full p-2 gap-2 flex flex-col">
        ...
        <section className="flex items-center justify-between gap-2 md:gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            >
              <RefreshCcw
                className={`size-4 ${
                  isRefetchingAccountsPayable || isFetching
                    ? "animate-spin"
                    : ""
                }`}
              />
        ...
        <div className="flex-1 min-h-0">
          {isInfiniteScroll ? (
            <div
              ...
              id="accounts-payable-scroll-container"
            >
              <InfiniteScroll
                ...
                hasMore={
                  ...
                  (accountsPayableData?.meta.total || 0)
                }
                loader={
      ...
      <AccountPayableDetailModal
        accountPayable={
          accountsPayable.find((ap) => ap.id === selectedAccountPayableId) ||
          null
        }
        open={modalOpen}
