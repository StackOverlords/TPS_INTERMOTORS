...
const OrderSelectorFilters: React.FC<OrderSelectorFiltersProps> = ({
  filters,
  updateFilter,
  resetFilters,
  handleManualSearch,
  ...
  const [debouncedProviderSearchTerm] = useDebounce<string>(
    providerSearchTerm,
    500
  );

  const { data: orderProvidersData, isLoading: isOrdersProvidersLoading } =
  ...
  return (
    <section className="space-y-2">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
        ...
        <div className="space-y-2">
          ...
          <ComboboxSelect
            ...
            options={
              orderProvidersData?.data.map((provider) => ({
                id: provider.id,
      ...
      <div className="flex gap-2 items-end justify-end flex-wrap">
        ...
        {searchMode === "manual" && (
          <Button onClick={handleManualSearch} className="w-full sm:w-auto">
...
export default OrderSelectorFilters;
