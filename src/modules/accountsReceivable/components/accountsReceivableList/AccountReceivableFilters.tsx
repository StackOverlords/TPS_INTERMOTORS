...
import type { useAccountReceivableFilters } from "../../hooks/useAccountReceivableFilters";

interface AccountReceivableFiltersProps {
    filters: ReturnType<typeof useAccountReceivableFilters>["filters"];
    updateFilter: ReturnType<typeof useAccountReceivableFilters>["updateFilter"];
    searchMode: "realtime" | "manual";
    handleManualSearch: () => void;
}

const AccountReceivableFilters: React.FC<AccountReceivableFiltersProps> = ({
    filters,
    updateFilter,
    searchMode,
    handleManualSearch,
...
export default AccountReceivableFilters;
