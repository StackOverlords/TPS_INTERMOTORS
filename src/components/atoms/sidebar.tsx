  ...
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[var(--sidebar-width)] bg-white p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 absolute inset-y-0 z-10 hidden h-svh w-[var(--sidebar-width)] transition-[left,right,width] ease-linear md:flex",
            side === "left"
    ...
    <TooltipWrapper
      tooltip={
        <p className="font-normal">
          Presiona{" "}
          <ShortcutKey useIcons combo={`ctrl+${SIDEBAR_KEYBOARD_SHORTCUT}`} />{" "}
          para {open ? "colapsar" : "expandir"} el sidebar
        </p>
      }
    >
      <Button
